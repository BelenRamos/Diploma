...
(3, 'Pedro Gómez', 'pedrogomez@example.com'),
...
(1, 'Martín González', 'Sánchez', 'martingonzalez@example.com', '555-555-5555'),
(2, 'Laura Rodríguez', 'Fernández', 'laurarodriguez@example.com', '666-666-6666'),
(3, 'Carlos López', 'Gutiérrez', 'carloslopez@example.com', '777-777-7777'),
(4, 'Silvia García', 'Martínez', 'silviagarcia@example.com', '888-888-8888');
Go
...
(1, 'Luisa Moreno', 'Hernández', 'luisamoreno@example.com', '999-999-9999', '1990-01-01', 1),
(2, 'Andrés Rodríguez', 'Gómez', 'andresrodriguez@example.com', '111-111-1111', '1995-02-02', 0),
(3, 'Mariana Silva', 'Pérez', 'marianasilva@example.com', '222-222-2222', '1985-03-03', 1),
(4, 'Javier Torres', 'López', 'javiertorres@example.com', '333-333-3333', '1992-04-04', 0);
Go
...
(1, 'Evaluación técnica', 'Aprobado', '2023-01-01', 'Ana Sánchez'),
(2, 'Entrevista personal', 'Rechazado', '2023-02-02', 'Juan Martínez'),
(3, 'Prueba de habilidades', 'Pendiente', '2023-03-03', 'María Rodríguez'),
(4, 'Evaluación psicológica', 'Aprobado', '2023-04-04', 'Carlos Gómez');
Go
